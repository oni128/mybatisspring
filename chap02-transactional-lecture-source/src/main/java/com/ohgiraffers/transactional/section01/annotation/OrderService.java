...
public class OrderService {
     ...
     *  MANDATORY : 반드시 트랜잭션을 걸고 현재 메소드를 실행하되 진행중인 트랜잭션이 있으면 예외를 던진다. - 다른쪽에서 발생하면 화낼거야
    ...
    @Transactional(propagation = Propagation.REQUIRED, isolation = Isolation.DEFAULT, rollbackFor = Exception.class) /*내부적으로 자동으로 Connection객체 할당되어 메소드가 끝나면 자동으로 커밋, 중간에 잘못되면 자동 롤백. */
    /*기본적으로는 READ_COMMITTED, 특정 상황에서 롤백하고 싶은 경우에도 설정 가능.*/
